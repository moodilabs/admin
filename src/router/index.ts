...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'audit-logs', name: 'audit-logs', component: () => import('@/views/audit/AuditLogsPage.vue'), meta: { title: '감사 로그' } },
      { path: 'api-logs', name: 'api-logs', component: () => import('@/views/audit/ApiLogsPage.vue'), meta: { title: 'API 로그' } },
    ],
  },
